    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-farma-900 mb-4">Entre em Contato</h2>
          <div className="w-20 h-1 bg-farma-500 mx-auto mb-6"></div>
          <p className="max-w-2xl mx-auto text-farma-700">
            Estamos à disposição para responder suas dúvidas, receber sugestões ou agendar uma consulta farmacêutica.
          </p>
        </div>

        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-xl p-8 h-full">
            <h3 className="text-2xl font-semibold text-farma-800 mb-6">Informações de Contato</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-farma-600">farmasete@fortuna.jard.com.br</p>                  
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-farma-600">Rua Coronel José Theodoro, 555 - Centro</p>
                  <p className="text-farma-600">Jardinópolis, SP - CEP 14680-000</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-farma-800 mb-1">Horário de Funcionamento</h4>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-farma-100 p-3 rounded-full hover:bg-farma-200 transition-colors">
                  <svg className="h-5 w-5 text-farma-600" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://wa.me/5516982002524" target="_blank" rel="noopener noreferrer" className="bg-farma-100 p-3 rounded-full hover:bg-farma-200 transition-colors">
                  <svg className="h-5 w-5 text-farma-600" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl shadow-xl p-8">
            <h3 className="text-2xl font-semibold text-farma-800 mb-6">Envie-nos uma Mensagem</h3>
            
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-farma-700 mb-2">
                    Nome Completo
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-farma-700 mb-2">
                    E-mail
                  </label>
                  <input
                    type="email"
              ...
              <div className="mb-6">
                <label htmlFor="message" className="block text-sm font-medium text-farma-700 mb-2">
                  Mensagem
                </label>
                <textarea
                  id="message"
