...
const Services = () => {
  ...
  const services = [
    {
      ...
      image: "/assets/dermatologicos.jpg",
      description:
        "Formulações personalizadas para o tratamento de diversos problemas de pele, desde acne até dermatites, com concentrações ajustadas às necessidades individuais.",
      items: [
        "Cremes anti-aging",
    ...
    },
    {
      ...
      image: "/assets/alopatia.jpg",
      description:
        "Medicamentos tradicionais que atuam diretamente no combate aos sintomas e causas das doenças, formulados com precisão e seguindo rigorosamente as prescrições médicas.",
      items: [
    ...
    },
    {
      ...
      image: "/assets/fitoterapicos.jpg",
      description:
        "Medicamentos à base de plantas medicinais, desenvolvidos com extratos padronizados e seguindo as boas práticas de manipulação.",
      items: [
        "Extratos vegetais",
        "Cápsulas de ervas",
        "Tinturas especiais",
    ...
    },
    {
      ...
      image: "/assets/hormonios.jpg",
      description:
        "Reposição hormonal personalizada, com doses ajustadas às necessidades individuais, sempre sob prescrição médica.",
      items: [
        "Reposição hormonal",
    ...
    },
    {
      ...
      image: "/assets/homeopaticos.jpg",
      description:
        "Medicamentos homeopáticos preparados individualmente, respeitando os princípios da homeopatia e garantindo a qualidade e eficácia do tratamento.",
      items: [
        "Glóbulos",
        "Tinturas-mãe",
    ...
    },
    {
      ...
      image: "/assets/suplementos.jpg",
      description:
        "Suplementos nutricionais formulados para atender às necessidades específicas de cada pessoa, com foco na saúde e bem-estar.",
      items: [
  ...
  return (
    <section
      id="services"
      className="py-20 bg-gradient-to-b from-white to-farma-50"
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-farma-700">
            Desenvolvemos fórmulas personalizadas para atender às necessidades
            específicas de cada paciente, sempre com o compromisso de qualidade
            e excelência.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/3 bg-farma-50 p-6">
              <h3 className="text-xl font-semibold text-farma-800 mb-6">
                Categorias
              </h3>
            ...
            <div className="md:w-2/3 p-8">
              <div className="mb-6 flex items-center">
                ...
                <h3 className="text-2xl font-semibold text-farma-800">
                  {activeService.name}
                </h3>
              </div>
              ...
              <div className="mt-8 bg-farma-100 rounded-lg p-4 text-farma-800 flex items-start">
                <svg
                  className="w-6 h-6 text-farma-500 mr-3 flex-shrink-0 mt-0.5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-farma-800 mb-2">
              Laboratório Moderno
            </h3>
            <p className="text-farma-700">
              Contamos com equipamentos de última geração para garantir a
              qualidade e precisão de nossas formulações.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-farma-700">
              Nossos colaboradores são altamente qualificados e estão sempre
              disponíveis para atender às suas necessidades.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-farma-700">
              Oferecemos um atendimento humanizado e personalizado, focado nas
